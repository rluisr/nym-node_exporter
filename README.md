# Nym Operator Metrics Prometheus Exporter

Retrieves JSON data from the Harbourmaster API (https://harbourmaster.nymtech.net/v2/gateways/) for a Nym gateway and exposes it as Prometheus metrics. 
